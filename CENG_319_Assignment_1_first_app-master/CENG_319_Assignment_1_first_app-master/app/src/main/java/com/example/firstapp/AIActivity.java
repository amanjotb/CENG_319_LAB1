...
public class AIActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView tvv = (TextView) findViewById(R.id.changetext2);
        TextView tv = (TextView) findViewById(R.id.changetext1);
        TextView textv = (TextView) findViewById(R.id.changetext);
    ...
    public void onPause() {
        ...
        //Gets the text view element by id
        TextView textView = (TextView) findViewById(R.id.changetext1);
        TextView textVieww = (TextView) findViewById(R.id.changetext2);
